...
export const parseAndInjectE2ESessions = async (node, repository) => {
    ...
    console.log('[PARSE_INJECT_NODES_FOUND]', nodes.length, nodes.map(n => n.attrs));
    ...
    for (const nodesChunk of chunks) {
        for (const node of nodesChunk) {
            ...
            console.log('[PARSE_INJECT_USER]', { jid, registrationId, hasSKey: !!signedKey, hasKey: !!key, hasIdentity: !!identity });
